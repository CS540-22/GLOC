...
Map<String, String> languageImages = {
  ...
  "BizTalk Orchestration": "biztalk-services.svg",
  "BizTalk Pipeline": "biztalk-services.svg",
...
Map<String, List<String>> languageColors = {
  ...
  "BizTalk Orchestration": ["5bb3db", "117dc4", "bbd434"],
  "BizTalk Pipeline": ["5bb3db", "117dc4", "bbd434"],
  ...
  "SQL": ["157cc8", "bdd659", "7cbc04"],
  "SQL Data": ["157cc8", "bdd659", "7cbc04"],
  "SQL Stored Procedure": ["157cc8", "bdd659", "7cbc04"],
  "Stylus": ["343434"],
